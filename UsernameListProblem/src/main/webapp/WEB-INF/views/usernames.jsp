...
<div class="container">
    ...
    <div class="row" style="margin-top:100px;">
       ...
       <div class="col-sm-6" style="text-align:right;">
	    	<a href="newUsername" class="btn btn-info" role="button">New Username</a>
	   </div>
	   <div class="col-sm-3">
       ...
       <div class="col-sm-3">
	    ...
	    <div class="col-sm-6">
            ...
            <c:forEach var="username" items="${listUsername}">
                <tr>
                    <td class="col-md-8">${username.value}</td>
                    <td class="col-md-2"><a href="deleteRestrictedWord/${username.id}">Delete</a></td>
                </tr>
            </c:forEach>
        </table>
	    </div>
